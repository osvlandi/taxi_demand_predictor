...
# Function that generates the average of rides of the past 4 weeks
...
# Custom transformation that generates temporal features
...
# Takes in a set of hyperparameters and outputs a scikit-learn pipeline
